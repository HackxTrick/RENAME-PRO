...
async def start(client, message):
    ...
    loading_sticker_message = await message.reply_sticker("CAACAgUAAxkBAAIX8GYNOuIgc2tahDN4dP8fkVGDIr39AALuDAAC_Ao4VkHrI6hJz81hNAQ")
    ...
    await message.reply_photo(photo=BOT_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                        ...
                                        InlineKeyboardButton("💬 Support", url="https://t.me/GAURAV_BOTS")],
                                        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
				                        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                                        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/ANIME_TIMETV")]
                                        ]))
    return
